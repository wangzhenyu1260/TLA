var FormValidation = function () {
    ...
    var changePwdFormValidation = function() {
        // for more info visit the official plugin documentation: 
            // http://docs.jquery.com/Plugins/Validation

            var changePwdform = $('#ChangPwdForm');
            var error = $('.alert-danger', changePwdform);
            var success = $('.alert-success', changePwdform);
            ...
            $("button:reset").click(function() {
				...
				$(".fa-check").closest('.fa').removeClass("fa-check");
